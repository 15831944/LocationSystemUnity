...
public class AddDepartmentTreeViewManger : MonoBehaviour {

    public static AddDepartmentTreeViewManger Instance;
    public AddDepartTreeView Tree;
    ...
    public void showDepUI(bool B)
    {
        ...
        else
        {
            ...
            AddPersonnel.Instance.CurrentId = (int)SelectdepNode.Id;
            AddPersonnel.Instance.departText.text = SelectdepNode.Name;
    ...
    public void NodeSelected(TreeNode<TreeViewItem> node)
    {
        ...
        if (node.Item.Tag is Department)
        {
            ...
            AddPersonnel.Instance.departText.text = depNode.Name;
