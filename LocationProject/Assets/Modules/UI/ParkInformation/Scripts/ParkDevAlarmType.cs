...
public class ParkDevAlarmType : MonoBehaviour {

    public static ParkDevAlarmType instance;
    ...
    void Start()
    {
        ...
        DevTypedropdownItem.onValueChanged.AddListener(ParkDevAlarmInfo.Instance.GetScreenAlarmType);
