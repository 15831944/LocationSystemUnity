...
public class ParkDevAlarmLevel : MonoBehaviour {

    public static ParkDevAlarmLevel instance;
    ...
    void Start()
    {
        ...
        devAlarmLeveldropdown.onValueChanged.AddListener(ParkDevAlarmInfo.Instance.GetScreenDevAlarmItem);
    }
